  ...
  private readonly routes: XeicRoute[] = [
    {
      ...
      description:
        'Ascensió tècnica amb vistes espectaculars a tota la comarca. Terreny pedregós i exigent que recompensa amb panoràmiques úniques dels Ports de Beseit.',
      distance: 14.2,
      elevationGain: 850,
      estimatedTime: '2:15',
      type: 'mountain',
    ...
    },
    {
      ...
      description:
        'Recorregut planer ideal per a iniciació o tirades suaus entre patrimoni viu. Passa vora els olivers mil·lenaris del terme de la Sénia.',
      distance: 8.5,
      elevationGain: 60,
      estimatedTime: '0:50',
      type: 'road',
    ...
    },
    {
      ...
      description:
        "Circular clàssica combinant pista forestal i senders vora l'aigua. Molt agraïda a la primavera quan la vegetació floreix.",
      distance: 12.0,
      elevationGain: 220,
      estimatedTime: '1:20',
      type: 'mixed',
    ...
    },
    {
      ...
      description:
        "Ruta circular pels voltants de la Sénia que travessa camps d'oliveres i garrofers amb vistes al Montsià.",
      distance: 12.5,
      elevationGain: 240,
      estimatedTime: '1:30',
      type: 'mixed',
    ...
    },
    {
      ...
      description:
        'Ascensió de referència dels Ports de Beseit. Una ruta dura que posa a prova fins als corredors més experimentats.',
      distance: 18.2,
      elevationGain: 950,
      estimatedTime: '2:45',
      type: 'mountain',
    ...
    },
    {
      ...
      description:
        'Ruta pels impressionants Estrets del riu Sénia, un congost espectacular que sorprèn a tothom qui el visita.',
      distance: 15.0,
      elevationGain: 800,
      estimatedTime: '2:10',
      type: 'mountain',
